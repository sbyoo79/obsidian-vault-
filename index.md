...
vault 의 카테고리별 카탈로그. 1 페이지당 1 줄로 간결하게 유지한다.
운영 규칙은 [[CLAUDE]] 참고.
...
- [[Agentic Engineering]] — 에이전트 시대의 엔지니어링 재설계 흐름
- [[AI Agent]] — LLM 기반 자율 실행 주체
- [[Context Engineering]] — LLM/에이전트용 컨텍스트 자산화
- [[Solomon's Paradox]] — 타인 문제는 잘 풀고 자기 문제는 못 푸는 편향
- [[Self-Distancing]] — 자기 거리두기로 의사결정 회복하는 기법
